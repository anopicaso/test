...
Public Class FrmSanPham
    ...
    Dim chuoiketnoi As String = "workstation id=baoveasm.mssql.somee.com;packet size=4096;user id=onepiece2004_SQLLogin_1;pwd=oz3ohhlex4;data source=baoveasm.mssql.somee.com;persist security info=False;initial catalog=baoveasm"
